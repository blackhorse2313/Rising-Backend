...
def get_qrimg_prompt(prompt, image):
    parameters = {
        "prompt": prompt,
        "height": 512,
        "width": 512,
        "steps": 35,  # Adjusted to match new metadata
        "sampler_name": "DPM++ 2M Karras",
        "cfg_scale": 8,
        "seed": -1,  # Adjusted seed
        "sd_model_name": "v1-5-pruned-emaonly",  # Adjusting to the provided model name
        "alwayson_scripts": {
            "controlnet": {
                "args": [
                    {
                    ...
                    },
                    {
                        "input_image": "",
                        "module": "inpaint_global_harmonious",
                        "model": "control_v1p_sd15_qrcode [9c780d03]",
                        "weight": 0.355,
                        "resize_mode": "Crop and Resize",
                        "lowvram": False,
                        "guidance_start": 0.35,
                    ...
                    {
                        "input_image": image,  # pass image uploaded here
                        "module": "inpaint_global_harmonious",
